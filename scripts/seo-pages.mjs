...
export const pages = [
  ...
  },
  {
    ...
    ogImage: '/assets/images/hero-skiff.webp',
    ogImageAlt: 'Ruderboot als Motiv zur Geschichte Karl Adams',
    index: true
  },
  {
    ...
    ogImage: '/assets/images/hero-skiff.webp',
    ogImageAlt: 'Ruderboot als neutrales Motiv zum historischen Hintergrund von Adams Acht',
    index: true
  },
  {
    ...
    ogImageAlt: 'Deutschlandachter als Motiv zur Geschichte des Olympiasiegs 1960',
    index: true
  },
  {
    ...
    ogImageAlt: 'Achter bei der Internationalen Ratzeburger Ruderregatta auf dem Küchensee',
    index: true
  },
  {
    ...
    ogImageAlt: 'Grafische Darstellung von Belastung und Erholung im Rudertraining',
    index: true
  },
  {
    path: '/rudern-verstehen/', file: 'rudern-verstehen/index.html',
    title: 'Rudern verstehen: Skull, Riemen, Achter & Ruderschlag | Adams Erben',
    description: 'Rudern einfach erklärt: Skull und Riemen, Achter und Steuerperson, Ruderschlag, Schlagzahl, Rigging und der Weg vom Verstehen zum Ausprobieren.',
    ...
    ogImage: '/assets/images/hero-skiff.webp',
    ogImageAlt: 'Ruderboot als Motiv für den Einstieg in die Technik des Ruderns',
    index: true
  },
  {
    ...
    ogImage: '/assets/images/hero-skiff.webp',
    ogImageAlt: 'Ruderboot als Motiv für den Einstieg ins Rudern',
    index: true
  },
  {
    ...
    ogImage: '/assets/images/hero-skiff.webp',
    ogImageAlt: 'Ruderboot als Motiv für die Rudervereinssuche',
    index: true
  },
  {
    path: '/ueber-adams-erben/', file: 'ueber-adams-erben/index.html',
    title: 'Über Adams Erben: Initiative, Quellen & Redaktion | Adams Erben',
    description: 'Was ist Adams Erben? Erfahre, wie die unabhängige Initiative historische Aussagen prüft, Quellen auswählt, Rechte behandelt und Korrekturen aufnimmt.',
    ogTitle: 'Über Adams Erben: Initiative, Quellen & Redaktion',
    ogDescription: 'Unabhängigkeit, Quellenarbeit, historische Verantwortung, Rechte und Korrekturprinzipien von Adams Erben.',
    ogImage: '/assets/images/hero-skiff.webp',
    ogImageAlt: 'Ruderboot als Motiv der unabhängigen Initiative Adams Erben',
    index: true
  }
];
